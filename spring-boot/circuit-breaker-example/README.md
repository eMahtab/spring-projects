...
## TMDB API KEY
This project calls APIs from [The Movie DB](https://www.themoviedb.org/) , you would need to replace the API_KEY in application.properties file in movie-info-service and movie-review-service, while running this project.

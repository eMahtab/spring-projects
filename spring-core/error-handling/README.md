...
**Although we were able to handle errors, but we introduced a lot of error handling code (try with one/multiple catch blocks) at multiple places in our controller methods.**
